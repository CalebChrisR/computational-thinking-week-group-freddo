...
def act1_par1():
    print(
        "Jesus is born in the manger. His mother, Mary, just knows that the Holy Spirit is with him." \
...
def act3_par1():
    print(
        ...
        "Mary, Judas, and the Holy Spirit wait outside Jesus' resting place." \
