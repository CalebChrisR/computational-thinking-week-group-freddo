...
def act2_par6():
    print('Once Steve has finished, he joins c4 and the Holy Spirit at the window, watching '
...
def act3_par6():
    ...
    'travelling through time again. The Holy Spirit and Lady Gaga continue their concert. c4, Judas, '
