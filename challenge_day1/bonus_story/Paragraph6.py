def act1_par6():
    return('ch6 cannot stand the screaming, “I am out of here,” so he twists '
...
def act2_par6():
    return('Once ch6 has finished, he joins ch4 and the ch2 at the window, watching '
    'as ch1 is pulled away to die. ch5 looks a little pained, but not that repentant. '  
    'They ask ch6, “how did you know?” ch3 listens in. ch6 mumbles, “what a wicked ' 
    'problem,” and twists the hat to disappear.')

def act3_par6():
    return('ch6, upon seeing that they are all happy, pops his guitar away and bows. '
