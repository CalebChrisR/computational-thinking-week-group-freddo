# Act 1
def act1_par2 ():
    return("ch1 takes a breath. The ch2 flows within ch1, and also ch4. " \
...
" their cups, and gossip about who is gonna win the local dog race. The ch2" \
" turns the wine back into water, because they are sober.")

# Act 3
def act3_par2 ():
    return("The ch2 realises that they have the power to change this." \
